...
export class ZKNavigationSettngTab extends PluginSettingTab {
    ...
    async display() {
        ...
        new Setting(mainNotesDiv)
            .setName(t("Option 2: Metadata is note ID"))
            .setDesc(t("Specify a frontmatter field for note's ID"))
            .addText((cb) =>
        ...
        new Setting(branchToolbarDiv)
            ...
            .addToggle(toggle => toggle.setValue(this.plugin.settings.NodeSpacingToggle)
                .onChange((value) =>{
                    this.plugin.settings.NodeSpacingToggle = value;
                    this.plugin.RefreshIndexViewFlag = true;
                }) 
            )
