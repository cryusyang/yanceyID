export default {
    ...
    "Option 2: Metadata is note ID": "笔记属性作为ID",
    ...
    "Suggest mode of index modal": "选择关键词搜索模式",
    "Suggest mode of main note modal": "选择主笔记搜索模式",
    "Keyword Order": "关键词排序",
    "Fuzzy Suggest": "模糊搜索",
    "ID Order": "ID/标题排序",
    "Set red dash line for nodes with ID ends with letter": "为ID以字母结尾的笔记节点连线设置为红色虚线",
    "In order to distinguish nodes which ID ends with letter and number": "用来区分ID以数字结尾的节点",
    "Fold node toggle": "节点折叠开关",
    "Open the fold icon(🟡🟢)": "开启节点折叠图标(🟡🟢)",
    "zk-index-view": "索引视图",
    ...
    //main.ts
    "open_main_view": "打开主视图",
    "open_index_view": "打开索引视图",
    "main_view": "主视图", 
    "index_view": "索引视图", 
    "Main notes": "📄主笔记",
    '📖index': '📖关键词',
    "Copy zk-navigation URI":"复制 zk-navigation 链接",
    "reveal_file_in_main_view": "在主视图中显示当前文件",
